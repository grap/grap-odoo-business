...
class TestModule(TransactionCase):
    ...
    def setUp(self):
        ...
        self.supplierinfo = self.env.ref(
            "purchase_package_qty.supplierinfo_supplier_1")
    ...
    def test_04_supplierinfo_change_package_qty_lower_not_rounded(self):
        ...
        self.assertEqual(
            self.supplierinfo.min_qty,
            50,
            "set a package_qty lower than the min_qty should round"
            " the min_qty")
    ...
    def test_10_purchase_order_line_onchange_package_strict(self):
        ...
        self.assertEqual(
            self.purchase_order_line.product_qty, 120,
