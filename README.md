...
[mrp_product_price_quick_menus](mrp_product_price_quick_menus/) | 16.0.1.1.1 |  | Adds menus to help manage price between BoMs and Products.
...
[partner_hide_technical_company](partner_hide_technical_company/) | 16.0.2.0.1 |  | Hide partners created when creating companies.
[partner_hide_technical_employee](partner_hide_technical_employee/) | 16.0.2.0.1 |  | Hide partners created when creating employees.
[partner_hide_technical_fix_calendar](partner_hide_technical_fix_calendar/) | 16.0.2.0.1 |  | Glue module with calendar, to Hide partners created when creating elements.
[partner_hide_technical_fix_calendar_test](partner_hide_technical_fix_calendar_test/) | 16.0.2.0.1 |  | Test module
[partner_hide_technical_user](partner_hide_technical_user/) | 16.0.2.0.1 |  | Hide partners created when creating users.
[product_food](product_food/) | 16.0.1.1.1 |  | Products - Food Informations
[product_food_certification](product_food_certification/) | 16.0.1.0.1 |  | Products - Food Certification Informations
...
[sale_eshop](sale_eshop/) | 16.0.1.2.1 |  | Allow connection to Odoo eShop Project
[sale_recovery_moment](sale_recovery_moment/) | 16.0.2.0.1 |  | Manage Recovery Moments and Places for Sale Order
